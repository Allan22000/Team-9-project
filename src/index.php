      ...
      <div class="container-fluid p-3">
        <div class="row g-0">
          ...
          <div class="col-lg-4 col-sm-6 p-2">
            <a
              class="portfolio-box"
              href="assets/img/trophies/fullsize/13.jpeg"
              title="1 League Cup"
            >
              <img
                class="img-fluid"
                src="assets/img/trophies/fullsize/13.jpeg"
                alt="..."
              />
              <div class="portfolio-box-caption">
          ...
          <div class="row my-5 justify-content-center py-5">
              <div class="col-11">
                <div class="row">
                  ...
                  <div class="col-xl-2 col-md-4 col-sm-4 col-12"><h6 class="mb-3 mb-lg-4 bold-text "><b>MENU</b></h6><ul class="list-unstyled"><li><li>Home</li><li>About</li><li>Trophies</li><li>Contact</li></ul></div>
...
<!-- PHP Contact US starts -->

<!-- Prashant added name and email functionality -->
<!-- Reng added message functionality -->
<!-- Opening and closing database connection was done jointly -->
